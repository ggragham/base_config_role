...
WIREGUARD_CONFIG_NAME: wg0  # Name of the WireGuard configuration.
WIREGUARD_CONFIG_PATH_SRC: /path/to/config/{{ WIREGUARD_CONFIG_NAME }}.conf  # Source path for WireGuard configuration.
